...
//{
	...
	/** Descriptor que identifica un objeto de esta librerÃ­a */
	typedef unsigned int              fzhndl;
	/** Tipo que define una lista de parÃ¡metros */
	typedef std::vector<fuzzvar>      fuzzlist;
	/** Tipo que define un mapa de parÃ¡metros */
